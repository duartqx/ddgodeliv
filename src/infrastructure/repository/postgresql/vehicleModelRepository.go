...
var vehicleModelRepository *VehicleModelRepository

func GetVehicleModelRepository(db *sqlx.DB) *VehicleModelRepository {
	if vehicleModelRepository == nil {
		vehicleModelRepository = &VehicleModelRepository{db: db}
	}
